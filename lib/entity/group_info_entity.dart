class GroupInfoEntity {
	...
	GroupInfoEntity({this.groupType, this.maxMemberNum, this.groupOwner, this.custom, this.groupId, this.resultCode, this.groupNotification, this.memberNum, this.resultInfo, this.faceUrl, this.groupName, this.addOption, this.createTime, this.groupIntroduction, this.silenceAll, this.lastMsgTime, this.onlineMemberNum, this.lastInfoTime});
