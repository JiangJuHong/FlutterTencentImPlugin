...
class NodeVideoEntity extends NodeEntity{
	...
	NodeVideoEntity({this.snapshotPath, this.videoPath, this.snapshotInfo, this.videoInfo,  this.taskId});

	NodeVideoEntity.fromJson(Map<String, dynamic> json) {
		snapshotPath = json['snapshotPath'];
		videoPath = json['videoPath'];
		snapshotInfo = json['snapshotInfo'] != null ? new NodeVideoSnapshotInfo.fromJson(json['snapshotInfo']) : null;
		videoInfo = json['videoInfo'] != null ? new NodeVideoVideoInfo.fromJson(json['videoInfo']) : null;
...
class NodeVideoSnapshotInfo {
	...
	NodeVideoSnapshotInfo({this.size, this.width, this.type, this.uuid, this.height});
