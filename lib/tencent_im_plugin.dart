...
class TencentImPlugin {
  ...
  static Future<void> revokeMessage({
    ...
    return await _channel.invokeMethod('revokeMessage', {"sessionId": sessionId, "sessionType": EnumUtil.getEnumName(sessionType), "rand": rand, "seq": seq, "timestamp": timestamp});
  }
